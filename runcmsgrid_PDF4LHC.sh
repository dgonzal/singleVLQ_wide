...
LHAPDFCONFIG=`echo "/cvmfs/cms.cern.ch/slc6_amd64_gcc493/external/lhapdf/6.1.5-ikhhed/share/LHAPDF/../../bin/lhapdf-config"`
...
if [ "$domadspin" -gt "0" ] ; then 
    ...
    cp process/madevent/Events/GridRun_$rnum/events.lhe.gz events_presys.lhe.gz
fi

gunzip --force events_presys.lhe.gz
